...
from compare_validate import test_tresholds, get_model_config_paths, plot_crossmodel_comparative_bars, calculate_plot_data, \
...
if __name__ == '__main__':
    ...
    if args.compare_ner:
        model_names = []
        ner_names = None
        crossmodel_ner_confidences = []
        intent_names = None
        crossmodel_intent_confidences = []
        ...
        for p in get_model_config_paths():
            ...
            crossmodel_ner_confidences.append(ner_confidences)
            crossmodel_intent_confidences.append(intent_confidences)
        ...
        plot_crossmodel_comparative_bars(
            ...
            entities=ner_names,
            confidences=crossmodel_ner_confidences
        )
        ...
        plot_crossmodel_comparative_bars(
            ...
            confidences=crossmodel_intent_confidences
        )
